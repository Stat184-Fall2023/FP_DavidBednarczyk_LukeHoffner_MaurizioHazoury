...
nba23Data$`TS%` <- (nba23Data$`PTS` / (2 * (nba23Data$`FGA` + 0.44 * nba23Data$`FTA`))) * 100
...
firstHalfData <- nba23Data[, 1:18]
secondHalfData <- nba23Data[, c(1:3, 19:28)]
...
Basketball Reference - https://www.basketball-reference.com/leagues/NBA_2023_totals.html#totals_stats::pts 
