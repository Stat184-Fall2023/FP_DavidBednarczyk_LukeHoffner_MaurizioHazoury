...
#Fixing column names
colnames(nba23Data)[6] <- "MIN/GM"
colnames(nba23Data)[7] <- "PTS/GM"
colnames(nba23Data)[8] <- "FGM/GM"
colnames(nba23Data)[9] <- "FGA/GM"
colnames(nba23Data)[11] <- "3PM/GM"
colnames(nba23Data)[12] <- "3PA/GM"
colnames(nba23Data)[14] <- "FTM/GM"
colnames(nba23Data)[15] <- "FTA/GM"
colnames(nba23Data)[18] <- "FGM"
colnames(nba23Data)[19] <- "FGA"
colnames(nba23Data)[20] <- "3PM"
colnames(nba23Data)[21] <- "3PA"
colnames(nba23Data)[22] <- "2PM"
colnames(nba23Data)[23] <- "2PA"
colnames(nba23Data)[27] <- "FTA"
colnames(nba23Data)[28] <- "PTS"
