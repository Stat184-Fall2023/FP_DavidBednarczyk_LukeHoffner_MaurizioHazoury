...
#Fixing column names
colnames(nba23Data)[5] <- "MIN/GM"
colnames(nba23Data)[6] <- "PTS/GM"
colnames(nba23Data)[7] <- "FGM/GM"
colnames(nba23Data)[8] <- "FGA/GM"
colnames(nba23Data)[10] <- "3PM/GM"
colnames(nba23Data)[11] <- "3PA/GM"
colnames(nba23Data)[13] <- "FTM/GM"
colnames(nba23Data)[14] <- "FTA/GM"
colnames(nba23Data)[17] <- "FGM"
colnames(nba23Data)[18] <- "FGA"
colnames(nba23Data)[19] <- "3PM"
colnames(nba23Data)[20] <- "3PA"
colnames(nba23Data)[21] <- "2PM"
colnames(nba23Data)[22] <- "2PA"
colnames(nba23Data)[26] <- "FTA"
